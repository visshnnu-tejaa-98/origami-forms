...
export const ANALYTICS_EVENT_TYPES = [VIEWED, SUBMITTED, DRAFTED, PUBLISHED, EDITED] as const;
export const CREATOR_ACTIVITY_TYPES = [DRAFTED, PUBLISHED] as const;
export const RESPONDENT_ACTIVITY_TYPES = [SUBMITTED, VIEWED] as const;

export const ACTIVITIES = [DRAFTED, PUBLISHED, SUBMITTED, VIEWED] as const;