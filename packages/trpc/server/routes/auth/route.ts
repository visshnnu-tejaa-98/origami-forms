...
export const authRouter = router({
  createUser: publicProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      const decoded = jwt.decode(ctx.cookie)
      console.log({ developerName: ctx.developerName, decoded })
      ...
      if (!result) throw Error("Something went wrong while creating an user");
