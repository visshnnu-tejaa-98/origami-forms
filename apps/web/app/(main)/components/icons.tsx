...
const paths: Record<IconName, React.ReactNode> = {
    ...
    settings: (
        <>
            ...
            <path d="M19.4 14.6a1.5 1.5 0 0 0 .3 1.65l.06.05a1.8 1.8 0 1 1-2.55 2.55l-.05-.06a1.5 1.5 0 0 0-1.65-.3 1.5 1.5 0 0 0-.91 1.37v.14a1.8 1.8 0 1 1-3.6 0v-.07a1.5 1.5 0 0 0-.98-1.37 1.5 1.5 0 0 0-1.65.3l-.05.06a1.8 1.8 0 1 1-2.55-2.55l.06-.05a1.5 1.5 0 0 0 .3-1.65 1.5 1.5 0 0 0-1.37-.91h-.14a1.8 1.8 0 1 1 0-3.6h.07a1.5 1.5 0 0 0 1.37-.98 1.5 1.5 0 0 0-.3-1.65l-.06-.05a1.8 1.8 0 1 1 2.55-2.55l.05.06a1.5 1.5 0 0 0 1.65.3h.07a1.5 1.5 0 0 0 .91-1.37v-.14a1.8 1.8 0 1 1 3.6 0v.07a1.5 1.5 0 0 0 .91 1.37 1.5 1.5 0 0 0 1.65-.3l.05-.06a1.8 1.8 0 1 1 2.55 2.55l-.06.05a1.5 1.5 0 0 0-.3 1.65v.07a1.5 1.5 0 0 0 1.37.91h.14a1.8 1.8 0 1 1 0 3.6h-.07a1.5 1.5 0 0 0-1.37.91Z" />
        </>
    ),
    search: (
        <>
    ...
    sun: (
        <>
            <path d="M10.2 5.1c2.7-.2 4.9 1.9 4.8 4.6-.1 2.6-2.1 4.6-4.7 4.6-2.8.1-4.9-2-4.8-4.8.1-2.4 2-4.3 4.7-4.4Z" />
            <path d="M10.1 1.6v1.9M10 16.4v2M18.3 9.9h-1.9M3.6 10.1H1.7M15.9 4.2 14.6 5.5M5.4 14.7l-1.4 1.2M15.8 15.9l-1.2-1.3M5.5 5.4 4.1 4.1" />
        </>
    ),
    moon: (
        <>
            <path d="M15.8 12.6c-3.6 1.2-7.4-1-8-4.7-.3-1.8.4-3.5 1.6-4.7C5.5 3.7 3 6.6 3.2 10c.2 3.8 3.6 6.6 7.4 6.1 2.3-.3 4.2-1.7 5.2-3.5Z" />
            <path d="M14.6 3.4v2.1M15.7 4.4h-2.1" />
        </>
    )
}
